...
# If the directory's parents do not exist, this function will create them unless the option is disabled.
	public static function create (
		$directory				// <str> The directory that you want to create.
	,	$perm = 0755			// <octal> The mode / permissions (CHMOD) of the directory you're creating.
	,	$recursive = true		// <bool> If TRUE this method creates the parent directories. If FALSE, it won't.
	)							// RETURNS <bool> TRUE if directory exists at completion, FALSE if not.
...
/****** Move a directory, including all files contained ******/
	public static function move (
		$sourcePath		// <str> The directory that you want to move.
	,	$destPath		// <str> The directory that you want to move the source to.
	)					// RETURNS <bool> TRUE if directory was moved, FALSE if not.
...
# disable that functionality, which would prevent any deletion if it had child content.
	public static function delete (
		$directory			// <str> The directory that you want to create.
	,	$recursive = true	// <bool> If TRUE this method will delete all directory contents. If FALSE, it wont.
...
/****** Get Files in a Directory ******/
	...
	,	$recursive = false	// <bool> If TRUE, do a recursive search.
	,	$foldersToo = false	// <mixed> If TRUE, return all folders as well.
	)						// RETURNS <int:str> list of files, or array() on failure.
...
/****** Get Folders in a Directory ******/
	public static function getFolders (
		$directory				// <str> The directory path to scan.
	,	$recursive = false		// <bool> If TRUE, do a recursive search (will scan all sub-folders as well).
	)							// RETURNS <int:str> a list of the folders in the directory.
...
# This function scans a directory for specific files by name.
	...
	,	$recursive = true		// <bool> If TRUE, do a recursive search.
	,	$foldersToo = true		// <bool> If TRUE, return all folders with the same name as well.
	)							// RETURNS <int:str> list of files, or array() on failure.
...
/****** Set Owner (chown) of a Directory ******/
	...
	,	$owner = "_default_"	// <str> The owner name (user name) to give permissions on the directory / files.
	,	$recursive = false		// <bool> If TRUE, sets all recursive content to the same permissions.
...
/****** Set File Group (chgrp) of a Directory ******/
	public static function setGroup(
		$directory				// <str> The directory to set permissions on.
	,	$group = "_default_"	// <str> The name of the group to set.
	,	$recursive = false		// <bool> If TRUE, sets all recursive data to the same permissions.
	)							// <bool> RETURNS TRUE on success, FALSE on failure.
...
/****** Set Permissions (chmod) of a Directory ******/
	public static function setPermissions(
		$directory					// <str> The directory to set permissions on.
	,	$permissionMode = 755		// <int> The number used to set the permission mode (e.g. 755, etc)
	,	$recursive = false			// <bool> If TRUE, sets all contents inside to the same permissions.
	)								// <bool> RETURNS TRUE on success, FALSE on failure.
