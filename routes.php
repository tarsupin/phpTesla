...
/****** Prepare Navigation ******
URL segments are separated by forward brackets (i.e. "/") and are saved as the $url array.
...
if(count($url) > 0 && $url[0] != "")
{
	...
	while(true)
	{
		...
		if(File::exists(CONTROLLER_PATH . "/" . $checkPath . ".php"))
		{
			require(CONTROLLER_PATH . "/" . $checkPath . ".php"); exit;
		}
